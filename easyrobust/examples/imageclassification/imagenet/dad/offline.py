...
class PairedDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # Assuming the labels are the same since images are pairs
...
def main():
    ...
    dataset_train1 = datasets.ImageFolder("/shared/rsaas/common/ILSVRC2012/ILSVRC2012_img_train", train_transform)
    dataset_train2 = datasets.ImageFolder(".", train_transform)
    dataset_eval = datasets.ImageFolder("/shared/rsaas/common/ILSVRC2012/ILSVRC2012_img_train", val_transform)

    dataset_train = PairedDataset(dataset_train1, dataset_train2)
...
def train_one_epoch(
    ...
    teacher_on_adv = []
    for batch_idx, (input, adv_xrec, target) in enumerate(loader):
        last_batch = batch_idx == last_idx
        data_time_m.update(time.time() - end)
        
        input, adv_xrec, target = input.cuda(), adv_xrec.cuda(), target.cuda()
